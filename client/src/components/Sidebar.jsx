          ...
          <div className='relative py-2' ref={menuRef}>
            ...
            {isMenuOpen && (
              <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100'>
                <p onClick={() => { setIsMenuOpen(false); navigate('/profile'); }} className='cursor-pointer text-sm'>Edit Profile</p>
                <hr className='my-2 border-t border-gray-500' />
                <p onClick={() => { setIsMenuOpen(false); logout(); }} className='cursor-pointer text-sm'>Logout</p>
              </div>
            )}
          </div>
        </div>
